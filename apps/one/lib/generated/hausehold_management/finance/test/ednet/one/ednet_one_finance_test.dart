...
// test/ednet/one/ednet_one_finance_test.dart 
 
import "package:test/test.dart"; 
import "package:ednet_core/ednet_core.dart"; 
import "package:ednet_one/ednet_one.dart"; 
 
void testEdnetOneFinances( 
    EdnetDomain ednetDomain, OneModel oneModel, Finances finances) { 
  DomainSession session; 
  group("Testing Ednet.One.Finance", () { 
    ...
    test("From model entry to JSON", () { 
      var json = oneModel.fromEntryToJson("Finance"); 
      expect(json, isNotNull); 
 
      print(json); 
      //oneModel.displayEntryJson("Finance"); 
      //oneModel.displayJson(); 
      //oneModel.display(); 
    }); 
    ...
    test("Find finance by oid", () { 
      var randomFinance = oneModel.finances.random(); 
    ...
    test("Random finance", () { 
      var finance1 = oneModel.finances.random(); 
      expect(finance1, isNotNull); 
      var finance2 = oneModel.finances.random(); 
    ...
    test("Transaction undo and redo", () { 
      ...
      while (finance1 == finance2) { 
        finance2 = oneModel.finances.random();  
      } 
      var action1 = RemoveCommand(session, finances, finance1); 
      var action2 = RemoveCommand(session, finances, finance2); 
...
void main() { 
  ...
  var finances = oneModel.finances; 
  testEdnetOneFinances(ednetDomain, oneModel, finances); 
} 
