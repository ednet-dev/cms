...
// test/household_management/finances/household_management_finances_finance_test.dart 
 
import "package:test/test.dart"; 
import "package:ednet_core/ednet_core.dart"; 
import "package:household_management_finances/household_management_finances.dart"; 
 
void testHousehold_managementFinancesFinances( 
    Household_managementDomain household_managementDomain, FinancesModel financesModel, Finances finances) { 
  DomainSession session; 
  group("Testing Household_management.Finances.Finance", () { 
...
void main() { 
  ...
  testHousehold_managementFinancesFinances(household_managementDomain, financesModel, finances); 
} 
