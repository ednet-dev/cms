...
// test/household_management/project/household_management_project_project_test.dart 
 
import "package:test/test.dart"; 
import "package:ednet_core/ednet_core.dart"; 
import "package:household_management_project/household_management_project.dart"; 
 
void testHousehold_managementProjectProjects( 
    Household_managementDomain household_managementDomain, ProjectModel projectModel, Projects projects) { 
  DomainSession session; 
  group("Testing Household_management.Project.Project", () { 
...
void main() { 
  ...
  testHousehold_managementProjectProjects(household_managementDomain, projectModel, projects); 
} 
