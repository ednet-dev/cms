...
void testDemocracyDirectCitizens( 
  ...
  group("Testing Democracy.Direct.Citizen", () { 
    ...
    test("Select citizens by attribute, then add", () { 
      ...
      citizen.firstName = 'autobus'; 
      citizen.lastName = 'present'; 
      citizen.email = 'revolution'; 
    ...
    test("Update citizen non id attribute with failure", () { 
      ...
      afterUpdateEntity.firstName = 'point'; 
      expect(afterUpdateEntity.firstName, equals('point')); 
    ...
    test("Copy Equality", () { 
      ...
      expect(randomCitizen.email, equals(randomCitizenCopy.email)); 
    ...
    test("citizen session undo and redo", () { 
      var citizenCount = citizens.length; 
      var citizen = Citizen(citizens.concept); 
        citizen.firstName = 'wave'; 
      citizen.lastName = 'organization'; 
      citizen.email = 'winter'; 
      citizens.add(citizen); 
      expect(citizens.length, equals(++citizenCount)); 
      citizens.remove(citizen); 
      expect(citizens.length, equals(--citizenCount)); 
    ...
    test("Citizen update undo and redo", () { 
      ...
      var action = SetAttributeCommand(session, citizen, "firstName", 'understanding'); 
      action.doIt(); 
    ...
    test("Reactions to citizen actions", () { 
      ...
      var citizen = Citizen(citizens.concept); 
        citizen.firstName = 'explanation'; 
      citizen.lastName = 'highway'; 
      citizen.email = 'instruction'; 
      citizens.add(citizen); 
      expect(citizens.length, equals(++citizenCount)); 
      citizens.remove(citizen); 
      expect(citizens.length, equals(--citizenCount)); 
      ...
      var setAttributeCommand = SetAttributeCommand( 
        session, citizen, "firstName", 'computer'); 
