...
// lib/project/household/model.dart 
...
class HouseholdModel extends HouseholdEntries { 
  ...
  void fromJsonToProjectEntry() { 
    fromJsonToEntry(projectHouseholdProjectEntry); 
  } 
 
  void fromJsonToTaskEntry() { 
    fromJsonToEntry(projectHouseholdTaskEntry); 
  } 
 
  void fromJsonToMilestoneEntry() { 
    fromJsonToEntry(projectHouseholdMilestoneEntry); 
  } 
 
  void fromJsonToResourceEntry() { 
    fromJsonToEntry(projectHouseholdResourceEntry); 
  } 
 
  void fromJsonToRoleEntry() { 
    fromJsonToEntry(projectHouseholdRoleEntry); 
  } 
 
  void fromJsonToTeamEntry() { 
    fromJsonToEntry(projectHouseholdTeamEntry); 
  } 
 
  void fromJsonToSkillEntry() { 
    fromJsonToEntry(projectHouseholdSkillEntry); 
  } 
 
  void fromJsonToTimeEntry() { 
    fromJsonToEntry(projectHouseholdTimeEntry); 
  } 
 
  void fromJsonToBudgetEntry() { 
    fromJsonToEntry(projectHouseholdBudgetEntry); 
  } 
 
  void fromJsonToInitiativeEntry() { 
    fromJsonToEntry(projectHouseholdInitiativeEntry); 
  } 
  ...
  void initTasks() { 
    ...
    task2.status = 'opinion'; 
    task2.priority = 'thing'; 
  ...
  void initResources() { 
    ...
    resource1.name = 'agile'; 
    resource1.type = 'professor'; 
    resource1.cost = 62.736095953316294; 
    ...
    resource2.name = 'car'; 
    resource2.type = 'web'; 
    resource2.cost = 5.998434127370301; 
    ...
    resource3.name = 'end'; 
    resource3.type = 'up'; 
    resource3.cost = 36.26897080598941; 
  ...
  void initRoles() { 
    ...
    role1.title = 'truck'; 
    role1.responsibility = 'explanation'; 
  ...
  void initSkills() { 
    ...
    skill1.name = 'productivity'; 
    skill1.level = 'software'; 
  ...
  void initBudgets() { 
    ...
    budget1.amount = 85.73956598689072; 
    budget1.currency = 'train'; 
    ...
    budget2.amount = 32.68550630666426; 
    budget2.currency = 'umbrella'; 
    ...
    budget3.amount = 3.32440136955503; 
    budget3.currency = 'beach'; 
