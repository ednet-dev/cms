...
// test/project/household/project_household_initiative_test.dart 
 
import "package:test/test.dart"; 
import "package:ednet_core/ednet_core.dart"; 
import "package:project_household/project_household.dart"; 
 
void testProjectHouseholdInitiatives( 
    ProjectDomain projectDomain, HouseholdModel householdModel, Initiatives initiatives) { 
  ...
  group("Testing Project.Household.Initiative", () { 
    ...
    test("From model entry to JSON", () { 
      var json = householdModel.fromEntryToJson("Initiative"); 
      expect(json, isNotNull); 
 
      print(json); 
      //householdModel.displayEntryJson("Initiative"); 
      //householdModel.displayJson(); 
      //householdModel.display(); 
    }); 
    ...
    test("Find initiative by oid", () { 
      var randomInitiative = householdModel.initiatives.random(); 
    ...
    test("Random initiative", () { 
      var initiative1 = householdModel.initiatives.random(); 
      expect(initiative1, isNotNull); 
      var initiative2 = householdModel.initiatives.random(); 
    ...
    test("Update initiative non id attribute with failure", () { 
      ...
      afterUpdateEntity.name = 'health'; 
      expect(afterUpdateEntity.name, equals('health')); 
    ...
    test("initiative action undo and redo", () { 
      ...
      var initiative = Initiative(initiatives.concept); 
        initiative.name = 'future'; 
    var initiativeProject = householdModel.projects.random(); 
    ...
    test("Initiative update undo and redo", () { 
      var initiative = householdModel.initiatives.random(); 
      var action = SetAttributeCommand(session, initiative, "name", 'flower'); 
      action.doIt(); 
    ...
    test("Transaction undo and redo", () { 
      ...
      while (initiative1 == initiative2) { 
        initiative2 = householdModel.initiatives.random();  
      } 
      var action1 = RemoveCommand(session, initiatives, initiative1); 
      var action2 = RemoveCommand(session, initiatives, initiative2); 
    ...
    initiativeProject.initiatives.add(initiative); 
      ...
      var setAttributeCommand = SetAttributeCommand( 
        session, initiative, "name", 'output'); 
...
void main() { 
  ...
  var initiatives = householdModel.initiatives; 
  testProjectHouseholdInitiatives(projectDomain, householdModel, initiatives); 
} 
