...
// test/project/household/project_household_team_test.dart 
 
import "package:test/test.dart"; 
import "package:ednet_core/ednet_core.dart"; 
import "package:project_household/project_household.dart"; 
 
void testProjectHouseholdTeams( 
    ProjectDomain projectDomain, HouseholdModel householdModel, Teams teams) { 
  DomainSession session; 
  group("Testing Project.Household.Team", () { 
    ...
    test("From model entry to JSON", () { 
      var json = householdModel.fromEntryToJson("Team"); 
      expect(json, isNotNull); 
 
      print(json); 
      //householdModel.displayEntryJson("Team"); 
      //householdModel.displayJson(); 
      //householdModel.display(); 
    }); 
    ...
    test("Find team by oid", () { 
      var randomTeam = householdModel.teams.random(); 
    ...
    test("Random team", () { 
      var team1 = householdModel.teams.random(); 
      expect(team1, isNotNull); 
      var team2 = householdModel.teams.random(); 
    ...
    test("Update team non id attribute with failure", () { 
      ...
      afterUpdateEntity.name = 'restaurant'; 
      expect(afterUpdateEntity.name, equals('restaurant')); 
    ...
    test("team action undo and redo", () { 
      ...
      var team = Team(teams.concept); 
        team.name = 'boat'; 
    var teamProject = householdModel.projects.random(); 
    ...
    test("Team update undo and redo", () { 
      var team = householdModel.teams.random(); 
      var action = SetAttributeCommand(session, team, "name", 'music'); 
      action.doIt(); 
    ...
    test("Transaction undo and redo", () { 
      ...
      var team2 = householdModel.teams.random(); 
      while (team1 == team2) { 
        team2 = householdModel.teams.random();  
      } 
      var action1 = RemoveCommand(session, teams, team1); 
      var action2 = RemoveCommand(session, teams, team2); 
...
void main() { 
  ...
  var teams = householdModel.teams; 
  testProjectHouseholdTeams(projectDomain, householdModel, teams); 
} 
