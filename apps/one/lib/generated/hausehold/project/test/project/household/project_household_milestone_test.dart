...
// test/project/household/project_household_milestone_test.dart 
 
import "package:test/test.dart"; 
import "package:ednet_core/ednet_core.dart"; 
import "package:project_household/project_household.dart"; 
 
void testProjectHouseholdMilestones( 
    ProjectDomain projectDomain, HouseholdModel householdModel, Milestones milestones) { 
  ...
  group("Testing Project.Household.Milestone", () { 
    ...
    test("From model entry to JSON", () { 
      var json = householdModel.fromEntryToJson("Milestone"); 
      expect(json, isNotNull); 
 
      print(json); 
      //householdModel.displayEntryJson("Milestone"); 
      //householdModel.displayJson(); 
      //householdModel.display(); 
    }); 
    ...
    test("Find milestone by oid", () { 
      var randomMilestone = householdModel.milestones.random(); 
    ...
    test("Random milestone", () { 
      var milestone1 = householdModel.milestones.random(); 
      expect(milestone1, isNotNull); 
      var milestone2 = householdModel.milestones.random(); 
    ...
    test("Update milestone non id attribute with failure", () { 
      ...
      afterUpdateEntity.name = 'agreement'; 
      expect(afterUpdateEntity.name, equals('agreement')); 
    ...
    test("milestone action undo and redo", () { 
      ...
      var milestone = Milestone(milestones.concept); 
        milestone.name = 'electronic'; 
      milestone.date = new DateTime.now(); 
    var milestoneProject = householdModel.projects.random(); 
    ...
    test("Milestone update undo and redo", () { 
      var milestone = householdModel.milestones.random(); 
      var action = SetAttributeCommand(session, milestone, "name", 'end'); 
      action.doIt(); 
    ...
    test("Transaction undo and redo", () { 
      ...
      while (milestone1 == milestone2) { 
        milestone2 = householdModel.milestones.random();  
      } 
      var action1 = RemoveCommand(session, milestones, milestone1); 
      var action2 = RemoveCommand(session, milestones, milestone2); 
...
void main() { 
  ...
  var milestones = householdModel.milestones; 
  testProjectHouseholdMilestones(projectDomain, householdModel, milestones); 
} 
