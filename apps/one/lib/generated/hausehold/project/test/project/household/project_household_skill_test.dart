...
// test/project/household/project_household_skill_test.dart 
 
import "package:test/test.dart"; 
import "package:ednet_core/ednet_core.dart"; 
import "package:project_household/project_household.dart"; 
 
void testProjectHouseholdSkills( 
    ProjectDomain projectDomain, HouseholdModel householdModel, Skills skills) { 
  DomainSession session; 
  group("Testing Project.Household.Skill", () { 
    ...
    test("From model entry to JSON", () { 
      var json = householdModel.fromEntryToJson("Skill"); 
      expect(json, isNotNull); 
 
      print(json); 
      //householdModel.displayEntryJson("Skill"); 
      //householdModel.displayJson(); 
      //householdModel.display(); 
    }); 
    ...
    test("Find skill by oid", () { 
      var randomSkill = householdModel.skills.random(); 
    ...
    test("Random skill", () { 
      var skill1 = householdModel.skills.random(); 
      expect(skill1, isNotNull); 
      var skill2 = householdModel.skills.random(); 
    ...
    test("Update skill non id attribute with failure", () { 
      ...
      afterUpdateEntity.name = 'beginning'; 
      expect(afterUpdateEntity.name, equals('beginning')); 
    ...
    var skillResource = householdModel.resources.random(); 
    ...
    test("Skill update undo and redo", () { 
      var skill = householdModel.skills.random(); 
      var action = SetAttributeCommand(session, skill, "name", 'sun'); 
      action.doIt(); 
    ...
    test("Transaction undo and redo", () { 
      ...
      var skill2 = householdModel.skills.random(); 
      while (skill1 == skill2) { 
        skill2 = householdModel.skills.random();  
      } 
      var action1 = RemoveCommand(session, skills, skill1); 
      var action2 = RemoveCommand(session, skills, skill2); 
...
void main() { 
  ...
  var skills = householdModel.skills; 
  testProjectHouseholdSkills(projectDomain, householdModel, skills); 
} 
