...
// test/library/user/library_user_library_test.dart 
 
import "package:test/test.dart"; 
import "package:ednet_core/ednet_core.dart"; 
import "package:library_user/library_user.dart"; 
 
void testLibraryUserLibraries( 
    LibraryDomain libraryDomain, UserModel userModel, Libraries libraries) { 
  ...
  group("Testing Library.User.Library", () { 
    ...
    test("From model entry to JSON", () { 
      var json = userModel.fromEntryToJson("Library"); 
      expect(json, isNotNull); 
 
      print(json); 
      //userModel.displayEntryJson("Library"); 
      //userModel.displayJson(); 
      //userModel.display(); 
    }); 
    ...
    test("Find library by oid", () { 
      var randomLibrary = userModel.libraries.random(); 
    ...
    test("Random library", () { 
      var library1 = userModel.libraries.random(); 
      expect(library1, isNotNull); 
      var library2 = userModel.libraries.random(); 
    ...
    test("Update library non id attribute with failure", () { 
      ...
      afterUpdateEntity.name = 'secretary'; 
      expect(afterUpdateEntity.name, equals('secretary')); 
    ...
    test("Library update undo and redo", () { 
      var library = userModel.libraries.random(); 
      var action = SetAttributeCommand(session, library, "name", 'opinion'); 
      action.doIt(); 
    ...
    test("Transaction undo and redo", () { 
      ...
      while (library1 == library2) { 
        library2 = userModel.libraries.random();  
      } 
      var action1 = RemoveCommand(session, libraries, library1); 
      var action2 = RemoveCommand(session, libraries, library2); 
    ...
    test("Reactions to library actions", () { 
      ...
      libraryDomain.startCommandReaction(reaction); 
      var library = Library(libraries.concept); 
        library.name = 'marriage'; 
      libraries.add(library); 
      expect(libraries.length, equals(++libraryCount)); 
      libraries.remove(library); 
      expect(libraries.length, equals(--libraryCount)); 
 
      var session = libraryDomain.newSession(); 
      ...
      var setAttributeCommand = SetAttributeCommand( 
        session, library, "name", 'down'); 
      setAttributeCommand.doIt(); 
      expect(reaction.reactedOnUpdate, isTrue); 
      libraryDomain.cancelCommandReaction(reaction); 
    }); 
