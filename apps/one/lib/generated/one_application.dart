...
class OneApplication implements IOneApplication {
  ...
  void _initializeDomains() {
    ...
    try {
      ...
      ptpg.PlanningModel planningModel = projectPlanningDomain
          .getModelEntries("Planning") as ptpg.PlanningModel;
      ...
      hdfe.FinanceModel financeModel = householdFinanceDomain
          .getModelEntries("Finance") as hdfe.FinanceModel;
