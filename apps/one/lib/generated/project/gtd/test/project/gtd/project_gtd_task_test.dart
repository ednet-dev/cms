...
void testProjectGtdTasks( 
  ...
  group("Testing Project.Gtd.Task", () { 
    ...
    test("Update task non id attribute with failure", () { 
      ...
      afterUpdateEntity.description = 'agreement'; 
      expect(afterUpdateEntity.description, equals('agreement')); 
    ...
    test("Task update undo and redo", () { 
      ...
      var action = SetAttributeCommand(session, task, "description", 'accomodation'); 
      action.doIt(); 
