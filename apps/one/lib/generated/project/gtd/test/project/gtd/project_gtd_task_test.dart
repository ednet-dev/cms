...
void testProjectGtdTasks( 
  ...
  group("Testing Project.Gtd.Task", () { 
    ...
    test("Update task non id attribute with failure", () { 
      ...
      afterUpdateEntity.description = 'university'; 
      expect(afterUpdateEntity.description, equals('university')); 
    ...
    test("Task update undo and redo", () { 
      ...
      var action = SetAttributeCommand(session, task, "description", 'autobus'); 
      action.doIt(); 
    ...
    taskAction.tasks.add(task); 
      ...
      var setAttributeCommand = SetAttributeCommand( 
        session, task, "description", 'autobus'); 
