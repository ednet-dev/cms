...
void testProjectGtdInboxes( 
  ...
  group("Testing Project.Gtd.Inbox", () { 
    ...
    test("Update inbox non id attribute with failure", () { 
      ...
      afterUpdateEntity.items = 'call'; 
      expect(afterUpdateEntity.items, equals('call')); 
    ...
    test("Inbox update undo and redo", () { 
      ...
      var action = SetAttributeCommand(session, inbox, "items", 'table'); 
      action.doIt(); 
