...
void testEdnetcoreTasksProjects(
  ...
  group("Testing Ednetcore.Tasks.Project", () {
    ...
    test("Find project by attribute id", () {
      var randomProject = projects.random();
      var project = projects.singleWhereAttributeId("name", randomProject.name);
      expect(project, isNotNull);
    ...
    test("Find project by attribute", () {
      var randomProject = projects.random();
      var project = projects.firstWhereAttribute(
    ...
    test("Select projects by attribute", () {
      var randomProject = projects.random();
      var selectedProjects = projects.selectWhereAttribute(
          "description", randomProject.description);
      expect(selectedProjects.isEmpty, isFalse);
      selectedProjects.forEach(
          (se) => expect(se.description, equals(randomProject.description)));
    ...
    test("Copy projects", () {
      ...
      copiedProjects.forEach(
          (e) => expect(e, isNot(same(projects.singleWhereId(e.id!)))));
    ...
    test("Reactions to project actions", () {
      ...
      var setAttributeCommand =
          SetAttributeCommand(session, project, "description", 'right');
