...
abstract class EventStormingElement {
  ...
  ///
  /// This method creates a base Entity in the EDNet Core model from
  /// this Event Storming element. Subclasses should override this
  /// to provide more specific conversions.
  ednet_core.Entity<Object> toCoreModelEntity() {
    // Create a base entity
    final entity = ednet_core.Entity<Object>();
