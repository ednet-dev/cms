...
class OneApplication implements IOneApplication {
  ...
  void _initializeDomains() {
    // First try to load static domain models
    final domainModelPairs = ModelRegistry.getStaticDomainModels();
  ...
  /// Registers domain models in the application
  void _registerDomainModels(List<DomainModelPair> domainModelPairs) {
